  ...
  return (
    <nav className=" mb-20 flex items-center justify-between py-6">
        ...
        <div className="m-8 flex items-center justify-center gap-4 text-2xl ">
            <a href="www.linkedin.com/in/mohamed-amamra-336461324" target='_blank'><FaLinkedin className='hover:text-purple-400 transition-all ease-in delay-100 cursor-pointer' /></a>
